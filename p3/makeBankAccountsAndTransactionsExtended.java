		...
		try
		{
			...
			for( int i = 0; i < inputLines.size(); )
			{
				...
				if( inn.startsWith("new BankAccount") )
				{
					...
					oconnor_BankAccount ba = new oconnor_BankAccount(lastName, firstName, checkingInitialValue, savingsInitialValue);
				...
				if( inn.startsWith("new EnhancedBankAccount") )
				{
					...
					double checkingInitialValue = Double.parseDouble(st.nextToken());
					double savingsInitialValue = Double.parseDouble(st.nextToken());
					oconnor_EnhancedBankAccount eba = new oconnor_EnhancedBankAccount(lastName, firstName, checkingInitialValue, savingsInitialValue);
