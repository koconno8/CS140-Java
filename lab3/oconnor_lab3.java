		...
		try
		{
			...
			while((token = input.readLine()) != null)
			{
				...
				while(st.hasMoreTokens())
				{
					...
					if(!uniqueStrings.contains(token))
					{
			...
			System.out.println("Number of Unique Words:" + df.format(uniqueStrings.size()));
